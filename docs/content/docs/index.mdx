---
title: Introduction
description: Welcome to kodkod - the production-ready backend boilerplate generator.
---

# Introduction

**kodkod** is a modern CLI tool that generates production-ready backend boilerplate with your choice of framework, ORM, and database.
